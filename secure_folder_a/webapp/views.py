...
apikey= "78a4f8a70dc6f5adbf7a29b28f899746a39b009784f43579e5867acc3b45c5a1"
API_KEY="78a4f8a70dc6f5adbf7a29b28f899746a39b009784f43579e5867acc3b45c5a1"
...
def uploadFile(request):
    ...
    if file_sha=="a":
        ...
        eun='../media/'+str(file_sha)+'/safe-output.pdf'
        return render(request,'upload_f.html',{'context':file_name,'eun':eun})
